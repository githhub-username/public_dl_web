...
if (selected == "Breast Cancer Classification"):
    ...
    if st.button("Breast Cancer's Test Result"):
        ...
        if (Breast_Cancer_prediction[0] == 1):
          parkinsons_diagnosis = "Maligant tumor detected (Can spread from one cell to another)"
        else:
          parkinsons_diagnosis = "Benign tumor detected(Cannot spread from one cell to another)"
